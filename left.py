...
while(capture.isOpened()):
	...
	try:
		...
		if count_defects == 0:
			...
			cv2.putText(frame, "TWO : CLOCKWISE", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2,(0,0,255), 2)
			m.linear.x = 0
			m.angular.z = 0.5
		elif count_defects == 2:
			cv2.putText(frame, "THREE : COUNTERCLOCKWISE", (5, 50), cv2.FONT_HERSHEY_SIMPLEX, 2,(0,0,255), 2)
			m.linear.x = 0
			m.angular.z = -0.5
